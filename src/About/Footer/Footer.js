          ...
          <div className="container">
            <div className="cta d-block d-md-flex align-items-center px-5">
              <div>
                ...
                <h3 className="text-dark">We provide the best Homeopathic Treatment</h3>
              </div>
            </div>
            ...
            <div className="row">
              ...
              <div className="col-sm">
                ...
                <ul className="list-unstyled links">
                  <li><a href="tel:+917382325000"> <BiPhoneCall /> 91 7382325000</a></li>
                  <li><a href="https://maps.google.com/?q=Mehta+Rd,+opposite+Dic+Office,+old,+Focal+Point,+GTB+Nagar,+Amritsar,+Amritsar+Cantt.,+Punjab+143001" target='_blank' rel="noopener noreferrer"> <TfiLocationPin /> Amritsar, Punjab </a></li>
                </ul>
              </div>
              <div className="col-md-3">
                <h3 className='b'>Follow us</h3>
                <ul className="list-unstyled social">
                  <li><a href="https://www.facebook.com/DrDeolHomeopathy?mibextid=rS40aB7S9Ucbxw6v" target="_blank" rel="noopener noreferrer"><span className="icon-facebook"><FaFacebook /></span></a></li>
